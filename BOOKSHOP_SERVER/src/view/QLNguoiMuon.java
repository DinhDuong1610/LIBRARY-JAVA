...
public class QLNguoiMuon extends JPanel{
	...
	public QLNguoiMuon() {
		...
		lblSt_1_1.setBounds(10, 134, 118, 30);
		panel.add(lblSt_1_1);
		...
		tf_loc_sdt.setBounds(137, 68, 306, 30);
		...
		tf_loc_damuon_from.setBounds(137, 134, 126, 30);
		...
		tf_loc_damuon_to.setBounds(317, 134, 126, 30);
		...
		lblSt_1_1_1.setBounds(273, 134, 38, 30);
		...
		lblSt_1_1_2.setBounds(10, 191, 126, 30);
		...
		tf_loc_dangmuon_from.setBounds(137, 191, 126, 30);
		...
		lblSt_1_1_1_1.setBounds(273, 191, 38, 30);
		...
		tf_loc_dangmuon_to.setBounds(317, 191, 126, 30);
		...
		bt_luu.setBounds(182, 374, 118, 33);
		add(bt_luu);
